...
let mercury_revolution_speed = 1.5
let venus_revolution_speed = 1.2
let earth_revolution_speed = 0.9
let mars_revolution_speed = 0.7
let jupiter_revolution_speed = 0.5
let saturn_revolution_speed = 0.4
let uranus_revolution_speed = 0.2
let neptune_revolution_speed = 0.1
